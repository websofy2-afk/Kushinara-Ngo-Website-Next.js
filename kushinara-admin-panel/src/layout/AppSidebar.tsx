...
import { CalendarDays, ChevronDown, Ellipsis, Images, IndianRupee, KeySquare, LayoutDashboard, MessageCircleMore, Newspaper, NotebookText, ShieldCheck, User } from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  },
  {
  ...
  },
   {
    name: "Gallery",
    icon: <Images />,
    subItems: [{ name: "Photos", path: "/gallery/photos", pro: false },
    { name: "Videos", path: "/gallery/videos", pro: false }],
  },
  {
    icon: <CalendarDays />,
    name: "Events",
...
const othersItems: NavItem[] = [
  {
    ...
    subItems: [
      ...
      { name: "Sign Out", path: "/logout", pro: false },
    ],
  },
];
