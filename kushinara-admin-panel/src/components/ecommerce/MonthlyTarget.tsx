    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100">
          ...
          <div className="relative inline-block">
            ...
            >
              <DropdownItem
                ...
                className="flex w-full font-normal text-left text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400"
              >
                View More
              </DropdownItem>
              <DropdownItem
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
        <div>
          ...
          <p className="flex items-center justify-center gap-1 text-base font-semibold text-gray-800 ">
            $20K
            <svg
              width="16"
              height="16"
